...
GC_Analysis.plot_gc_skew(sequences, sequence_length=1000)

# Plot the GC skew across various genomes in one big visualization
GC_Analysis.plot_gc_skew_genome_set(sequences, sequence_length=1000)

# Plot a heatmap of the GC content across various sequences of the genome for various genomes.
GC_Analysis.gc_content_heatmap(sequences, sequence_length=1000)

# Plot Cumulative GC Content across all sequences
GC_Analysis.cumulative_gc_content_plot(sequences, sequence_length=1000)
